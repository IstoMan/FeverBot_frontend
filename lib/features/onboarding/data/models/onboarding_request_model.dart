...
class OnboardingRequestModel extends OnboardingRequestEntity {
  ...
  factory OnboardingRequestModel.fromJson(Map<String, dynamic> json) {
    return OnboardingRequestModel(
      ...
      systolic: json['blood_pressure_systolic'] as double? ?? 0.0,
      diastolic: json['blood_pressure_diastolic'] as double? ?? 0.0,
      gender: json['gender'] as String? ?? '',
      cholesterol: json['cholesterol'] as double? ?? 0.0,
      glucose: json['gluc_ordinal'] as double? ?? 0.0,
