...
class GetHomeUseCase
    implements UseCaseWithParams<HomeEntity, GetHomeDataUseCaseParams> {
  final HomeRepository repository;
  GetHomeUseCase(this.repository);
  @override
  ResultFuture<HomeEntity> call(GetHomeDataUseCaseParams params) async {
    return await repository.getHomeData(request: params.request);
  }
}

class GetHomeDataUseCaseParams {
  final HomeRequestEntity request;
  GetHomeDataUseCaseParams({required this.request});
}
