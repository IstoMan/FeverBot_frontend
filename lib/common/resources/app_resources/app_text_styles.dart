...
class AppTextStyles {
  ...
  /// Geist text styles
  static final geistExtraExtraLargeBold = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: bold,
  );
  static final geistExtraLargeBold = geist(
    fontSize: extraLargeFontSize,
    fontWeight: bold,
  );
  static final geistLargeBold = geist(
    fontSize: largeFontSize,
    fontWeight: bold,
  );
  static final geistMediumBold = geist(
    fontSize: mediumFontSize,
    fontWeight: bold,
  );
  static final geistNormalBold = geist(
    fontSize: defaultFontSize,
    fontWeight: bold,
  );
  static final geistSmallBold = geist(
    fontSize: smallFontSize,
    fontWeight: bold,
  );
  static final geistExtraSmallBold = geist(
    fontSize: extraSmallFontSize,
    fontWeight: bold,
  );
  static final geistMicroBold = geist(
    fontSize: microFontSize,
    fontWeight: bold,
  );

  static final geistVeryExtraMicroLight = geist(
    fontSize: veryExtraMicroFontSize,
    fontWeight: regular,
  );
  static final geistExtraMicroBold = geist(
    fontSize: extraMicroFontSize,
    fontWeight: bold,
  );

  static final geistExtraExtraLargeExtraBold = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: extraBold,
  );
  static final geistExtraLargeExtraBold = geist(
    fontSize: extraLargeFontSize,
    fontWeight: extraBold,
  );
  static final geistLargeExtraBold = geist(
    fontSize: largeFontSize,
    fontWeight: extraBold,
  );
  static final geistMediumExtraBold = geist(
    fontSize: mediumFontSize,
    fontWeight: extraBold,
  );
  static final geistNormalExtraBold = geist(
    fontSize: defaultFontSize,
    fontWeight: extraBold,
  );
  static final geistSmallExtraBold = geist(
    fontSize: smallFontSize,
    fontWeight: extraBold,
  );
  static final geistExtraSmallExtraBold = geist(
    fontSize: extraSmallFontSize,
    fontWeight: extraBold,
  );
  static final geistMicroExtraBold = geist(
    fontSize: microFontSize,
    fontWeight: extraBold,
  );

  static final geistExtraExtraLargeLight = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: light,
  );
  static final geistExtraLargeLight = geist(
    fontSize: extraLargeFontSize,
    fontWeight: light,
  );
  static final geistLargeLight = geist(
    fontSize: largeFontSize,
    fontWeight: light,
  );
  static final geistMediumLight = geist(
    fontSize: mediumFontSize,
    fontWeight: light,
  );
  static final geistNormalLight = geist(
    fontSize: defaultFontSize,
    fontWeight: light,
  );
  static final geistSmallLight = geist(
    fontSize: smallFontSize,
    fontWeight: light,
  );
  static final geistExtraSmallLight = geist(
    fontSize: extraSmallFontSize,
    fontWeight: light,
  );
  static final geistMicroLight = geist(
    fontSize: microFontSize,
    fontWeight: light,
  );

  static final geistExtraExtraLargeSemiBold = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: semiBold,
  );
  static final geistExtraLargeSemiBold = geist(
    fontSize: extraLargeFontSize,
    fontWeight: semiBold,
  );
  static final geistLargeSemiBold = geist(
    fontSize: largeFontSize,
    fontWeight: semiBold,
  );
  static final geistMediumSemiBold = geist(
    fontSize: mediumFontSize,
    fontWeight: semiBold,
  );
  static final geistNormalSemiBold = geist(
    fontSize: defaultFontSize,
    fontWeight: semiBold,
  );
  static final geistSmallSemiBold = geist(
    fontSize: smallFontSize,
    fontWeight: semiBold,
  );
  static final geistExtraSmallSemiBold = geist(
    fontSize: extraSmallFontSize,
    fontWeight: semiBold,
  );
  static final geistMicroSemiBold = geist(
    fontSize: microFontSize,
    fontWeight: semiBold,
  );

  static final geistExtraExtraLargeMedium = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: medium,
  );
  static final geistExtraExtraLargeMediumLight = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: light,
  );
  static final geistExtraLargeMedium = geist(
    fontSize: extraLargeFontSize,
    fontWeight: medium,
  );
  static final geistExtraLargeMediumLight = geist(
    fontSize: extraLargeFontSize,
    fontWeight: light,
  );
  static final geistNormalMediumLight = geist(
    fontSize: defaultFontSize,
    fontWeight: light,
  );
  static final geistLargeMedium = geist(
    fontSize: largeFontSize,
    fontWeight: medium,
  );
  static final geistLargeMediumLight = geist(
    fontSize: largeFontSize,
    fontWeight: light,
  );
  static final geistExtraSmallRegularLight = geist(
    fontSize: extraSmallFontSize,
    fontWeight: light,
  );
  static final geistSmallRegularLight = geist(
    fontSize: smallFontSize,
    fontWeight: light,
  );
  static final geistMediumMedium = geist(
    fontSize: mediumFontSize,
    fontWeight: medium,
  );
  static final geistNormalMedium = geist(
    fontSize: defaultFontSize,
    fontWeight: medium,
  );
  static final geistSmallMedium = geist(
    fontSize: smallFontSize,
    fontWeight: medium,
  );
  static final geistExtraSmallMedium = geist(
    fontSize: extraSmallFontSize,
    fontWeight: medium,
  );
  static final geistMicroMedium = geist(
    fontSize: microFontSize,
    fontWeight: medium,
  );

  static final geistExtraExtraLargeRegular = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: regular,
  );
  static final geistExtraLargeRegular = geist(
    fontSize: extraLargeFontSize,
    fontWeight: regular,
  );
  static final geistLargeRegular = geist(
    fontSize: largeFontSize,
    fontWeight: regular,
  );
  static final geistMediumRegular = geist(
    fontSize: mediumFontSize,
    fontWeight: regular,
  );
  static final geistNormalRegular = geist(
    fontSize: defaultFontSize,
    fontWeight: regular,
  );
  static final geistSmallRegular = geist(
    fontSize: smallFontSize,
    fontWeight: regular,
  );
  static final geistExtraSmallRegular = geist(
    fontSize: extraSmallFontSize,
    fontWeight: regular,
  );
  static final geistMicroRegular = geist(
    fontSize: microFontSize,
    fontWeight: regular,
  );

  static final geistExtraExtraLargeThin = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: thin,
  );
  static final geistExtraLargeThin = geist(
    fontSize: extraLargeFontSize,
    fontWeight: thin,
  );
  static final geistLargeThin = geist(
    fontSize: largeFontSize,
    fontWeight: thin,
  );
  static final geistMediumThin = geist(
    fontSize: mediumFontSize,
    fontWeight: thin,
  );
  static final geistNormalThin = geist(
    fontSize: defaultFontSize,
    fontWeight: thin,
  );
  static final geistSmallThin = geist(
    fontSize: smallFontSize,
    fontWeight: thin,
  );
  static final geistExtraSmallThin = geist(
    fontSize: extraSmallFontSize,
    fontWeight: thin,
  );
  static final geistMicroThin = geist(
    fontSize: microFontSize,
    fontWeight: thin,
  );

  static final geistExtraExtraLargeBlack = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: black,
  );
  static final geistExtraLargeBlack = geist(
    fontSize: extraLargeFontSize,
    fontWeight: black,
  );
  static final geistLargeBlack = geist(
    fontSize: largeFontSize,
    fontWeight: black,
  );
  static final geistMediumBlack = geist(
    fontSize: mediumFontSize,
    fontWeight: black,
  );
  static final geistNormalBlack = geist(
    fontSize: defaultFontSize,
    fontWeight: black,
  );
  static final geistSmallBlack = geist(
    fontSize: smallFontSize,
    fontWeight: black,
  );
  static final geistExtraSmallBlack = geist(
    fontSize: extraSmallFontSize,
    fontWeight: black,
  );
  static final geistMicroBlack = geist(
    fontSize: microFontSize,
    fontWeight: black,
  );

  static final geistExtraExtraLargeExtraLight = geist(
    fontSize: extraExtraLargeFontSize,
    fontWeight: extraLight,
  );
  static final geistExtraLargeExtraLight = geist(
    fontSize: extraLargeFontSize,
    fontWeight: extraLight,
  );
  static final geistLargeExtraLight = geist(
    fontSize: largeFontSize,
    fontWeight: extraLight,
  );
  static final geistMediumExtraLight = geist(
    fontSize: mediumFontSize,
    fontWeight: extraLight,
  );
  static final geistNormalExtraLight = geist(
    fontSize: defaultFontSize,
    fontWeight: extraLight,
  );
  static final geistSmallExtraLight = geist(
    fontSize: smallFontSize,
    fontWeight: extraLight,
  );
  static final geistExtraSmallExtraLight = geist(
    fontSize: extraSmallFontSize,
    fontWeight: extraLight,
  );
  static final geistMicroExtraLight = geist(
    fontSize: microFontSize,
    fontWeight: extraLight,
  );
